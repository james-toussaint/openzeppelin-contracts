...
[.contract]
[[ERC7786Recipient]]
=== `++ERC7786Recipient++` link:https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v5.4.0/contracts/crosschain/ERC7786Recipient.sol[{github-icon},role=heading-link]
